...
<asp:Content ID="Container" ContentPlaceHolderID="container" runat="server">
    <div class="row">
        <div class="col-sm-12 card well" style="margin: 50px auto;">
                ...
                <div>
                    ...
                    <div class="form-group col-12">
                        <asp:Button ID="Register" runat="server" Text="Register" CssClass="btn btn-custom form-control" OnClick="Register_Click" />
                    </div>
